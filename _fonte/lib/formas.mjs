...
const T = {
  ...
  // --- bola de Natal -------------------------------------------------------
  // Duas camadas: a de fora recortada, a de dentro lisa com o nome. É assim
  // que a peça é feita, e é isso que o desenho tem de mostrar.
  bola: `<circle cx="100" cy="112" r="58"/><circle cx="100" cy="112" r="40"/>
    <path d="M88 44h24v20H88z"/><path d="M100 44V30a12 12 0 0 1 24 0"/>
    <path d="M100 64v10M82 96l-8-8M118 96l8-8M82 128l-8 8M118 128l8 8"/>
    <path d="M84 108h32M90 120h20"/>`,

  // --- coroa da porta ------------------------------------------------------
  coroa: `<circle cx="100" cy="104" r="62"/><circle cx="100" cy="104" r="40"/>
    <path d="M100 42c-8 6-8 14 0 20 8-6 8-14 0-20M162 104c-6-8-14-8-20 0 6 8 14 8 20 0
      M100 166c8-6 8-14 0-20-8 6-8 14 0 20M38 104c6 8 14 8 20 0-6-8-14-8-20 0"/>
    <path d="M56 60c-6 8-4 16 4 18 4-8 2-16-4-18M144 60c6 8 4 16-4 18-4-8-2-16 4-18"/>
    <path d="M84 100h32M90 112h20"/>`,
